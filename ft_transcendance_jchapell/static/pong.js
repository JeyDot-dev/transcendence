...
function checkWin(){
	...
	document.getElementById("scoreValue").innerText = "Player: " + player.score + " - " + opponent.score + " :Opponent";
	if (player.score >= 5) {
		stopGame();
	}
	if (opponent.score >= 5) {
...
function stopGame(){
	...
	player.y = canvas.height / 2 - (ballSize * 10);
	opponent.y = canvas.height / 2 - (ballSize * 10);
}
